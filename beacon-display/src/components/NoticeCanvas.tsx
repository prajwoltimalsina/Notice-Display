...
export function NoticeCanvas({ notices, isEditable = false }: NoticeCanvasProps) {
      ...
      {publishedNotices.length === 0 && (
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <h3 className="text-xl font-medium text-muted-foreground">No notices to display</h3>
